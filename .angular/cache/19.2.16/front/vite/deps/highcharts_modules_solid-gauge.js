    ...
    function(t, e) {
      ...
      !function(t2) {
        t2.initDataClasses = function(t3) {
          ...
          for (let t4 = 0, o3 = r2.length; t4 < o3; ++t4) i2 = w(i2 = r2[t4]), a2.push(i2), (e2.styledMode || !i2.color) && ("category" === s2.dataClassColor ? (e2.styledMode || (n2 = (d2 = e2.options.colors || []).length, i2.color = d2[l2]), i2.colorIndex = l2, ++l2 === n2 && (l2 = 0)) : i2.color = b(s2.minColor).tweenTo(b(s2.maxColor), o3 < 2 ? 0.5 : t4 / (o3 - 1)));
      ...
      class D extends _ {
        ...
        drawPoints() {
          ...
          for (let i3 of (k(s2.threshold) && (t2 = e2.startAngleRad + e2.translate(s2.threshold, void 0, void 0, void 0, true)), this.thresholdAngleRad = T(t2, e2.startAngleRad), this.points)) if (!i3.isNull) {
            let t3 = z(T(i3.options.radius, s2.radius, 100)) * o2[2] / 200, l2 = z(T(i3.options.innerRadius, s2.innerRadius, 60)) * o2[2] / 200, d2 = Math.min(e2.startAngleRad, e2.endAngleRad), h2 = Math.max(e2.startAngleRad, e2.endAngleRad), c2 = i3.graphic, g2 = e2.startAngleRad + e2.translate(i3.y, void 0, void 0, void 0, true), p2, u2, f2 = e2.toColor(i3.y, i3), m2 = i3.getClassName();
            "none" === f2 && (f2 = i3.color || this.color || "none"), "none" !== f2 && (i3.color = f2), g2 = P(g2, d2 - n2, h2 + n2), false === s2.wrap && (g2 = P(g2, d2, h2));
            let y2 = a2 ? (t3 - l2) / 2 / t3 : 0, x2 = Math.min(g2, this.thresholdAngleRad) - y2, R2 = Math.max(g2, this.thresholdAngleRad) + y2;
            R2 - x2 > 2 * Math.PI && (R2 = x2 + 2 * Math.PI);
            let v2 = a2 ? "50%" : 0;
            s2.borderRadius && (v2 = C.optionsToObject(s2.borderRadius).radius), i3.shapeArgs = p2 = {
              x: o2[0],
              y: o2[1],
              r: t3,
              innerR: l2,
              ...
              fill: f2,
              "sweep-flag": 0
            }).add(this.group), this.chart.styledMode ? this.yAxis?.stops && (m2 = m2.replace(/highcharts-color-\d/gm, "").trim()) : ("square" !== s2.linecap && c2.attr({
